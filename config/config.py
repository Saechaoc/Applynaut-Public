...
chromeProfilePath = r"C:\Users\chris\AppData\Local\Google\Chrome\User Data\Default"
...
# , "analyst", "business", "FP&A", "Real Estate", "SQL", "Power BI", "Operations", "Investments"
keywords = ["Financial Analyst NOT CPA"]
...
blacklistCompanies = ["Amazon"]
# Blaclist keywords in title - ex:["manager", ".Net"]
blackListTitles = ['CPA', 'Accounting']
